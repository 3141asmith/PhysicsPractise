...
The bank contains 400 original questions: 215 calculations from 43 families with five deterministic numerical variants each, plus 185 individual written questions. Each of the eight separate Physics topics has 50 questions before filtering. Trilogy excludes Physics-only questions and Space physics, leaving 296 questions. This is a practice bank, not exhaustive specification coverage. Course and Higher-tier labels are independent. See [GCSE specification mapping](gcse-specification.md) for the source links and counts. Topic notes, biology and chemistry remain future work.
