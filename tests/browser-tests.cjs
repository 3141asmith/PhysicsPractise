...
(async()=>{
 ...
 try{
  ...
  await page.waitForFunction(()=>typeof School!=='undefined'&&School.user?.guest&&document.querySelectorAll('.question-link').length===1458);
  ...
  await page.waitForFunction(()=>document.querySelectorAll('.question-link').length===1458);
  ...
  await student.waitForFunction(()=>document.querySelectorAll('.question-link').length===1458);
  ...
  assert.ok(await student.locator('.question-link').count()<1458);
